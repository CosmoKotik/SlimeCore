...
{
    public class EntityLookAndRelativeMovePacket : IClientboundPacket, IPacket
    {
        public int Id { get; set; } = (int)CB_PlayPacketType.ENTITY_LOOK_AND_RELATIVE_MOVE;
        public Version Version { get; set; }

        private ClientHandler _handler;

        public EntityLookAndRelativeMovePacket(ClientHandler handler)
        {
        ...
        public object Broadcast(object obj = null, bool includeSelf = false)
        {
            ...
            bm.WriteByte(client.Pitch);   //Angle (byte)
